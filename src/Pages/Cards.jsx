...
const Cards = ({ data }) => {
    ...
    return (
        <>
            <div onClick={() => navigate(data?.path)} className='transition-all duration-300 group w-full md:w-[25%] h-[300px] hover:scale-90 hover:shadow-[0_05px_60px_-15px_rgba(0,0,255,0.5)] border rounded-md border-blue-800 cursor-pointer flex flex-col items-center'>
